...
VALUES ('Admin', 'admin@gmail.com', '$2b$10$wLyuMd5mP.D5YekcUa2uSQQIRXvXFyKmpz3go/ryHgHU1ihTtioa6', 1);
-- La contraseña es: 1

-- Insertar usuario Empleado (contraseña: 123456)
INSERT INTO usuarios (nombre, email, clave, id_rol)
VALUES ('Empleado', 'empleado@gmail.com', '$2b$10$wLyuMd5mP.D5YekcUa2uSQQIRXvXFyKmpz3go/ryHgHU1ihTtioa6', 2);
-- La contraseña es: 1
